...
<div class="container">
  <ul class="collection with-header">
    ...
    <li class="collection-header">
      ...
      <p>Merci davantage d'avoir effectué une commande dans notre plateforme !</p>
      <p>L'administrateur vous contactera pour donner les informations ainsi que l'heure de la livraison.</p>
    </li>
  ...
  <ul class="collection with-header">
    <li class="collection-item">
      ...
      @if($order->state->slug === 'cheque')
        <p>Veuillez attendre la livraion.</p>
        <p>Pas la peine de nous envoyer un chèque avec :</p>
        <ul>
          <li>- montant du règlement : <strong>{{ number_format($order->total * (1 + $order->tax) + $order->shipping, 2, '', ' ') }} Fcfa</strong></li>     
      ...
      @elseif($order->state->slug === 'virement')
        ...
        <ul>
          <li>- montant du virement : <strong>{{ number_format($order->total * (1 + $order->tax) + $order->shipping, 2, '', ' ') }} Fcfa</strong></li>
      ...
      <p>Pour toute question ou information complémentaire merci de nous contacter par e-mail.</p>
    </li>
  </ul>
