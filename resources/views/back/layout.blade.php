...
<body class="hold-transition sidebar-mini" style="font-family:areal">
<div class="wrapper">
  <!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('home') }}" class="nav-link"><b>Voir la boutique</b></a>
      </li>
    </ul>
  </nav>
  <!-- /.navbar -->
  ...
  <footer class="main-footer">
    <!-- Default to the left -->
    <strong style="font-family:areal">Copyright &copy; 2020 {{ $shop->name }}.</strong>
