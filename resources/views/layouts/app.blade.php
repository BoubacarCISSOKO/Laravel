...
<body style="font-family:areal">
  ...
  <footer class="page-footer" style="font-family:areal; font-size:20px">
    <div class="container">
      <div class="row">
    ...
    <div class="footer-copyright">
      <div class="container">
        © 2020 Team AB agence
        <a class="grey-text text-lighten-4 right" href="https://mobile.facebook.com/home.php?_rdc=1&_rdr" target="_blank"><img src="/images/facebook.png" alt="Facebook"></a>
      </div>
    </div>
  </footer>
  @yield('javascript')
